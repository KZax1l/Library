 ...
 * <p>
 * {@link CoordinatorLayout}是增强版的{@link android.widget.FrameLayout}
 ...
 * </ol>
 * <p>
 * {@link CoordinatorLayout}主要有两个用途：1.作为根布局来使用；2.作为一个或多个子控件进行相互作用的容器
 ...
 * <p>
 * 通过为其子控件指定{@link Behavior}，不仅可以给这个{@link CoordinatorLayout}内提供许多不同的交互，
 * 同时它的子控件之间也可以彼此影响
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    /**
     * 用来存放CoordinatorLayout_keylines属性值
     */
